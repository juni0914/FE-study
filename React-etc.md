...
이렇게 함으로써 예외 없이 데이터를 처리할 수 있게 된다.<br><br><br><br>

단점으로는, 여러 데이터가 업데이트 되면 이상한 효과를 만들어 React의 렌더링 메소드가 다른 controller-view에 의해 반복적으로 실행되서<br><br> 디버깅의 어려움을 가중할 가능성이 있다.<br><br>
변화를 감지하고 화면을 업데이트하는 코드를 매번 작성해야 한다.<br><br>
